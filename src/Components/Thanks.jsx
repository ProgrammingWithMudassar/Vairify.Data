    ...
    return (
        <Box my={4} mx={1}>
            <Container className='thanks'>
                ...
                <Typography variant="h4" mb={4} color="#fff" fontWeight={600}>Special Thank You and Message</Typography>
                ...
                <Box sx={{textAlign:'center',mb:4}}>
                    <Typography variant="h4" color="#fff" fontWeight={600} mb={4} >WellCome Home</Typography>
